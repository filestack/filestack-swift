...
@objc(FSAVTransform) public class AVTransform: Transform {
     ...
     */
    @objc @discardableResult public func preset(_ value: String) -> Self {
     ...
     */
    @objc @discardableResult public func force(_ value: Bool) -> Self {
     ...
     */
    @objc @discardableResult public func title(_ value: String) -> Self {
    ...
    /**
     ...
     transcoding process.
     */
    @objc @discardableResult public func extName(_ value: String) -> Self {
    ...
    /**
     ...
     process.
     */
    @objc @discardableResult public func fileName(_ value: String) -> Self {
     ...
     */
    @objc @discardableResult public func location(_ value: StorageLocation) -> Self {
     ...
     */
    @objc @discardableResult public func path(_ value: String) -> Self {
     ...
     */
    @objc @discardableResult public func access(_ value: StorageAccess) -> Self {
    ...
    /**
     ...
     should end up.
     */
    @objc @discardableResult public func container(_ value: String) -> Self {
     ...
     */
    @objc @discardableResult public func upscale(_ value: Bool) -> Self {
     ...
     */
    @objc @discardableResult public func aspectMode(_ value: TransformAspectMode) -> Self {
     ...
     */
    @objc @discardableResult public func twoPass(_ value: Bool) -> Self {
     ...
     */
    @objc @discardableResult public func videoBitRate(_ value: Int) -> Self {
    ...
    /**
     ...
     the source file.
     */
    @objc @discardableResult public func fps(_ value: Int) -> Self {
     ...
     */
    @objc @discardableResult public func keyframeInterval(_ value: Int) -> Self {
     ...
     */
    @objc @discardableResult public func audioBitRate(_ value: Int) -> Self {
     ...
     */
    @objc @discardableResult public func audioSampleRate(_ value: Int) -> Self {
     ...
     */
    @objc @discardableResult public func audioChannels(_ value: Int) -> Self {
     ...
     */
    @objc @discardableResult public func clipLength(_ value: String) -> Self {
     ...
     */
    @objc @discardableResult public func clipOffset(_ value: String) -> Self {
     ...
     */
    @objc @discardableResult public func watermarkURL(_ value: URL) -> Self {
     ...
     */
    @objc @discardableResult public func watermarkTop(_ value: Int) -> Self {
    ...
    /**
     ...
     watermark on the video. Valid range: `0...9999`
     */
    @objc @discardableResult public func watermarkBottom(_ value: Int) -> Self {
    ...
    /**
     ...
     watermark on the video. Valid range: `0...9999`
     */
    @objc @discardableResult public func watermarkLeft(_ value: Int) -> Self {
    ...
    /**
     ...
     watermark on the video. Valid range: `0...9999`
     */
    @objc @discardableResult public func watermarkRight(_ value: Int) -> Self {
     ...
     */
    @objc @discardableResult public func watermarkWidth(_ value: Int) -> Self {
     ...
     */
    @objc @discardableResult public func watermarkHeight(_ value: Int) -> Self {
