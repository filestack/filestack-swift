...
class TransformableTests: XCTestCase {
    private let processStubConditions = isScheme(Constants.apiURL.scheme!) && isHost(Constants.apiURL.host!)
    ...
    func testMinifyJSTransformationWithOptionalsURL() {
        ...
        let expectedURL = Constants.apiURL.appendingPathComponent("minify_js=booleans:true,builtIns:false," +
